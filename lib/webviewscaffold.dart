...
class WebviewScaffoldx extends StatefulWidget {

  const WebviewScaffoldx({
    Key key,
    this.appBar,
    @required this.url,
    this.headers,
  ...
  @override
  _WebviewScaffoldxStatex createState() => _WebviewScaffoldxStatex();
}

class _WebviewScaffoldxStatex extends State<WebviewScaffoldx> {
      ...
      _onStateChanged = webviewReference.onStateChanged.listen((WebViewStateChanged state) {
        ...
        if (state.type == WebViewState.finishLoad) {
          ...
          setState(() {
            ...
            String urlx = state.url;
            if(urlx.contains(".mp4") || urlx.contains(".avi") || urlx.contains(".mkv")){
              if(!PlayingVideo) {
                VideoUrl = urlx;
                PlayingVideo = true;
                webviewReference.close();
